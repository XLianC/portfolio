        ...
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
                    Reach me out to start collaborating on something amazing!
                </p>
            ...
            <form action="https://getform.io/f/bjjjxqyb" method="POST" className="xl:pl-10 2xl:pl-20">
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    <div className="mb-4">
                        ...
                        <input type="text" name="name" id="name" autoComplete="name" required placeholder="Walter Adrian Samuel" className="text-field" />
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        <input type="email" name="email" id="email" autoComplete="email" required placeholder="walter.adrian@student.umn.ac.id" className="text-field" />
                    </div>
                </div>
                ...
                <div className="mb-4"> 
                    ...
                    <textarea name="message" id="message" placeholder="Send Me A Message" required className="text-field resize-y min-h-32 max-h-80"></textarea>
                </div>
